...
#[derive(Debug)]
pub struct HtmxAjaxProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HtmxAjaxProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HtmxAjax processing");
    
    let mut processor = HtmxAjaxProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HtmxAjaxProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HtmxAjaxProcessor::new(false);
